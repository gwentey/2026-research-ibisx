...
> Règle absolue applicable à tout projet Zelian. Fichier livré par Zelian Builder (projets neufs) ou copié depuis le plugin `zelian-framework` par `/zelian:retro` — ne pas modifier au projet.
>
